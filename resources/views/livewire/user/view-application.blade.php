    ...
    <div>
        <div>
            ...
            <div class="mt-6 border-t border-gray-100">
              ...
              <dl class="divide-y divide-gray-100">
                ...
                <div class="bg-white px-4 py-1 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-3">
                  ...
                  <dd class="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0 uppercase">{{ Carbon\Carbon::parse($record->schedule->date)->format('F d, Y') }} - ({{$record->convertHour}})</dd>
                </div>
                <div class="bg-gray-50 px-4 py-1 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-3">
          ...
          <div class="mt-3 ml-2 flex items-center justify-start gap-x-3">
            ...
            @else
            <button wire:click="downloadORCR" type="button" class="rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">
                Download OR\CR
            </button>
